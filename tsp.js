...

{
  ...
  {  // CONSTANTS ================================================================================
    ...
    // Colours ------------------------------------------------------------------
    {
      ...
      var RED           = [255,  0,  0,255]; 
      var ORANGE        = [255,127,  0,255]; 
      
      var REDORANGE    = [255, 81,  0,255];

      var YELLOWORANGE = [255,190,  0,255];
...
var largeArea=0;
          ...
          function convexHull(){
            ...
            if(!p.loaded){
              ...
              // getGreedyTour(p.hullNodes, GREEDY_MODES.CLOSEST);
