...
/*
    ...
    TO DO:
      ...
      - display ideal path on mouseOver of hexButton
...
// ellipse(offset,-offset,this.w,this.w);
              ...
              if(app.complete){ text(this.total,   offset, offset); }
              else            { text(this.integer, offset, offset); }
